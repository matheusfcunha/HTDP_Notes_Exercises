...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise_86) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
; Exercise 86 https://htdp.org/2018-01-06/Book/part_one.html#%28counter._%28exercise._struct-edit3%29%29
...
(define TEXT-SIZE 11)
(define STRING-PER-WIDTH (/ (* TEXT-SIZE 100) EMPTSCN-WIDTH))
(define TEXT-MAX-STRINGS (floor (/ EMPTSCN-WIDTH STRING-PER-WIDTH )))
...
(define editor-ex9 (make-editor (make-string  TEXT-MAX-STRINGS #\a) "" ))
(define editor-ex10 (make-editor "" (make-string  TEXT-MAX-STRINGS #\a)))
(define editor-ex11 (make-editor (make-string  (+ (floor (/ TEXT-MAX-STRINGS 2)) 1) #\a) (make-string  (+ (floor (/ TEXT-MAX-STRINGS 2)) 1) #\a)))
...
; Ignores a KeyEvent if text is too wide for canvas.
...
(check-expect (edit editor-ex1 "\t") editor-ex1)   
(check-expect (edit editor-ex1 "\r") editor-ex1)    
(check-expect (edit editor-ex9 "a") editor-ex9)
(check-expect (edit editor-ex10 "a") editor-ex10)
(check-expect (edit editor-ex11 "a") editor-ex11)
...
(define (edit ed ke) 
  (cond
    ...
    [ (and (> (string-length ke) 1) (or (equal? ke "left") (equal? ke "right")))  ; cursor
     ...
     [(equal? (string-length ke) 1) ; allphabet keys
       (if (or (>= (string-length (editor-pre ed)) TEXT-MAX-STRINGS) (>= (string-length (editor-post ed)) TEXT-MAX-STRINGS) ; text too wide
               (>= (string-length (string-append (editor-pre ed) (editor-post ed))) TEXT-MAX-STRINGS))
               (make-editor (editor-pre ed) (editor-post ed))
        (make-editor (string-insert ke (editor-pre ed) (string-length (editor-pre ed))) (editor-post ed))) ] 
