...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname Exercise_62) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
(define LOCKED "locked")
(define CLOSED "closed")
(define OPEN "open")
(define CLOCK-TICK-RATE 3)
...
(define (door-simulation initial-state)
  (big-bang initial-state
    [on-tick door-closer CLOCK-TICK-RATE]
    [on-key door-action]
    [to-draw door-render]))


; DoorState -> DoorState   |   String -> String
...
; DoorState KeyEvent -> DoorState     |       String String -> String
