...
(check-expect (si-move-proper (make-fired ufo-ex1 tank-ex1 (make-posn 15 100)) ufo-jump-ex1) (make-fired (make-posn 25 18) (make-tank 18 3) (make-posn 15 106) )   )
(define (si-move-proper s ufo-x-delta)
  (cond
    [(aim? s) (make-aim (move-tank (aim-tank s)) (move-ufo (aim-ufo s) ufo-x-delta)) ]
    [(fired? s) (make-fired (move-tank (fired-tank s)) (move-ufo (tank-ufo s)) (move-missile (fired-missile s)))]
    )
  )
